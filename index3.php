...
<div class="container">
     ...
     <div class="hero-unit">
        <h1>Aloha</h1>
        <p>StandupPRO foi desenvolvido para gerir eventos de Standup Paddle Race. Em parceria com a Associação Baiana de Standup (ABASUP) desde 2014 o sistema já computou mais de 20 Etapas Estaduais e quatro edições de nível nacional pela CBSUP. Podendo ser aplicado em diversos outros eventos como natação, triatlo, karts e corridas em gerais.</p>
        <div class="media pull-right">
          <img class="media-object" width="200px" src="standuppro.png">
        </div>
        <p><a href="/abasup" class="btn btn-primary btn-large">Confira &raquo;</a></p>
