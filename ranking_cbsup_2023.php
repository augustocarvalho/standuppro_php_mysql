...
echo " <div class=row> 
            ...
            <br>";
                    ...
                    while ($result2 = mysqli_fetch_assoc($categoria)){
                     echo '<h2 align="center">' . "RANKING CBSUP 2023 " .  '</h2>';
...
,ifnull((SELECT colocacao FROM ranking WHERE atleta_cpf = r.atleta_cpf and etapa_idetapa = 53 and categoria_idcategoria = r.categoria_idcategoria), '-') as col_etapa2 
,ifnull((SELECT pontos FROM ranking WHERE atleta_cpf = r.atleta_cpf and etapa_idetapa = 53 and categoria_idcategoria = r.categoria_idcategoria), 0) as pontos2
,ifnull((SELECT colocacao FROM ranking WHERE atleta_cpf = r.atleta_cpf and etapa_idetapa = 54 and categoria_idcategoria = r.categoria_idcategoria), '-') as col_etapa3 
,ifnull((SELECT pontos FROM ranking WHERE atleta_cpf = r.atleta_cpf and etapa_idetapa = 54 and categoria_idcategoria = r.categoria_idcategoria), 0) as pontos3  
FROM ranking r
JOIN atleta a ON a.cpf = r.atleta_cpf
WHERE etapa_idetapa in (51,53,54)
) as resul
