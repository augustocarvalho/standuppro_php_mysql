...
echo " <div class=row> 
            ...
            <br>";
              ...
              if ( $id_categoria <> 0) {
                   ...
                   <tbody> ";
                      $sql = mysqli_query($con,"SELECT nome, estado, cpf, categoria_idcategoria, col_etapa1, pontos1, col_etapa2, pontos2, col_etapa3, pontos3, (pontos1 + pontos2 + pontos3)  as soma
                             FROM (
...
WHERE etapa_idetapa in (58, 60,62)
) as resul
