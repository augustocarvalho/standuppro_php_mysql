...
echo " <div class=row> 
            ...
            <br>";
                    ...
                    while ($result2 = mysqli_fetch_assoc($categoria)){
                     echo '<h2 align="center">' . "RANKING CBSUP 2024 " .  '</h2>';
              ...
              if ( $id_categoria <> 0) {
                   ...
                   <tbody> ";
                      $sql = mysqli_query($con,"SELECT nome, estado, cpf, categoria_idcategoria, col_etapa1, pontos1, col_etapa2, pontos2, col_etapa3, pontos3,col_etapa4, pontos4, (pontos1 + pontos2 + pontos3 + pontos4)  as soma
                             FROM (
...
,ifnull((SELECT colocacao FROM ranking WHERE atleta_cpf = r.atleta_cpf and etapa_idetapa = 62 and categoria_idcategoria = r.categoria_idcategoria), '-') as col_etapa3 
,ifnull((SELECT pontos FROM ranking WHERE atleta_cpf = r.atleta_cpf and etapa_idetapa = 62 and categoria_idcategoria = r.categoria_idcategoria), 0) as pontos3  
,ifnull((SELECT colocacao FROM ranking WHERE atleta_cpf = r.atleta_cpf and etapa_idetapa = 63 and categoria_idcategoria = r.categoria_idcategoria), '-') as col_etapa4 
,ifnull((SELECT pontos FROM ranking WHERE atleta_cpf = r.atleta_cpf and etapa_idetapa = 63 and categoria_idcategoria = r.categoria_idcategoria), 0) as pontos4  
FROM ranking r
JOIN atleta a ON a.cpf = r.atleta_cpf
WHERE etapa_idetapa in (58,60,62,63)
) as resul
