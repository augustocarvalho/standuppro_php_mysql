...
echo " <div class=row> 
            ...
            <br>";
                    ...
                    while ($result2 = mysqli_fetch_assoc($categoria)){
                     echo '<h2 align="center">' . "RANKING ABASUP 2022 " .  '</h2>';
              ...
              if ( $id_categoria <> 0) {
                   ...
                   <tbody> ";
                      ...
                      ,  discarte1 
                            ...
                            , (Select count(*) FROM ranking rr WHERE atleta_cpf = cpf AND etapa_idetapa in (50,49,48,47,46) AND colocacao = 1 and rr.categoria_idcategoria = resul.categoria_idcategoria) as primeiros
                            ,(Select count(*) FROM ranking rr WHERE atleta_cpf = cpf AND etapa_idetapa in  (50,49,48,47,46) AND colocacao = 2 and rr.categoria_idcategoria = resul.categoria_idcategoria) as segundos
                            , (Select count(*) FROM ranking rr WHERE atleta_cpf = cpf AND etapa_idetapa in (50,49,48,47,46) AND colocacao = 3 and rr.categoria_idcategoria = resul.categoria_idcategoria) as terceiros 
                             FROM (
SELECT a.cpf, a.nome as nome, r.categoria_idcategoria 
,ifnull((SELECT colocacao FROM ranking WHERE atleta_cpf = r.atleta_cpf and etapa_idetapa = 46 and categoria_idcategoria = r.categoria_idcategoria), '-') as col_etapa1 
,ifnull((SELECT pontos FROM ranking WHERE atleta_cpf = r.atleta_cpf and etapa_idetapa = 46 and categoria_idcategoria = r.categoria_idcategoria), 0) as pontos1  
,ifnull((SELECT colocacao FROM ranking WHERE atleta_cpf = r.atleta_cpf and etapa_idetapa = 47 and categoria_idcategoria = r.categoria_idcategoria), '-') as col_etapa2 
,ifnull((SELECT pontos FROM ranking WHERE atleta_cpf = r.atleta_cpf and etapa_idetapa = 47 and categoria_idcategoria = r.categoria_idcategoria), 0) as pontos2  
,ifnull((SELECT colocacao FROM ranking WHERE atleta_cpf = r.atleta_cpf and etapa_idetapa = 48 and categoria_idcategoria = r.categoria_idcategoria), '-') as col_etapa3 
,ifnull((SELECT pontos FROM ranking WHERE atleta_cpf = r.atleta_cpf and etapa_idetapa = 48 and categoria_idcategoria = r.categoria_idcategoria), 0) as pontos3  
,ifnull((SELECT colocacao FROM ranking WHERE atleta_cpf = r.atleta_cpf and etapa_idetapa = 49 and categoria_idcategoria = r.categoria_idcategoria), '-') as col_etapa4 
,ifnull((SELECT pontos FROM ranking WHERE atleta_cpf = r.atleta_cpf and etapa_idetapa = 49 and categoria_idcategoria = r.categoria_idcategoria), 0) as pontos4
,ifnull((SELECT colocacao FROM ranking WHERE atleta_cpf = r.atleta_cpf and etapa_idetapa = 50 and categoria_idcategoria = r.categoria_idcategoria), '-') as col_etapa5 
,ifnull((SELECT pontos FROM ranking WHERE atleta_cpf = r.atleta_cpf and etapa_idetapa = 50 and categoria_idcategoria = r.categoria_idcategoria), 0) as pontos5
, d.discarte1
FROM ranking r
JOIN atleta a ON a.cpf = r.atleta_cpf
LEFT JOIN discartes d ON d.atleta_cpf = r.atleta_cpf and d.categoria_idcategoria = r.categoria_idcategoria and ano = 2022 and id_circuito = 1
WHERE etapa_idetapa in (46, 47,48, 49,50)
) as resul
...
ORDER BY total desc, primeiros desc, segundos desc, terceiros desc");
                       while ($row = mysqli_fetch_assoc($sql)){
                           ...
                           $menor = array($row['pontos1'], $row['pontos2'], $row['pontos3'], $row['pontos4'], $row['pontos5'] );
                            sort($menor);
                            // mysqli_query($con,"update discartes SET discarte1 = $menor[0] WHERE atleta_cpf = $row[cpf] and categoria_idcategoria = $id_categoria and ano = 2022 and id_circuito = 1");
                            echo '<td>' . $count . '</td>';
