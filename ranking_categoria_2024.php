...
echo " <div class=row> 
            ...
            <br>";
              ...
              if ( $id_categoria <> 0) {
                   ...
                   <tbody> ";
                      $sql = mysqli_query($con,"SELECT nome, cpf, categoria_idcategoria, col_etapa1, pontos1, col_etapa2, pontos2, (pontos1+pontos2)  as soma
                        ,  (pontos1+pontos2) as total                            
                             FROM (
