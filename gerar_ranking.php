...
echo "<script>alert('ETAPA PONTUADA NO BAHIANO 2023!! ');</script>";
echo "<meta http-equiv='refresh' content='0, url=./ranking_categoria_2023.php'>";
?>