            ...
            <div class="row">
                <table cellpadding="0" cellspacing="0" border="0"   style="width: 600px"  align="center" class="table table-striped table-bordered">
                  ...
                  <?php
						...
						$count=1;
					    $sql = mysql_query("SELECT nome_participante, estado, pontos FROM ranking r join participante p  
															WHERE r.id_categoria='$id_categoria' and r.id_participante=p.id_participante order by pontos DESC");
